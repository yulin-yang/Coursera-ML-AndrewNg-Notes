...
- 为了方便我们更直观的理解，我们使用一个更简单的假设函数，暂时先不考虑$\theta_0$，即假设其为0
  ...
  ![1679038152663](../images/1679038152663.png)
...
![1679042904813](../images/1679042904813.png)
...
- 那么现在我们换一种方向。我们现在位于下图所示的 $\theta_1$ 处
  - ![1679045318859](../images/1679045318859.png)
